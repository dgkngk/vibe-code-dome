...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      <div
        className={`transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 shadow-lg h-screen flex flex-col ${isOpen ? "w-64 p-4" : "w-0 overflow-hidden"}`}
      >
