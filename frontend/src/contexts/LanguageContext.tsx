...
const translations: { [lang: string]: Translation } = {
  en: {
    ...
    "confirm.delete.workspace":
      "Are you sure you want to delete this workspace? This action cannot be undone and will permanently delete all associated boards, lists, and cards.",
    delete: "Delete",
    ...
    "confirm.delete.list":
      "Are you sure you want to delete this list? All cards in it will be permanently deleted.",
    ...
    "go.back.workspace": "Go back to workspace",
  ...
  tr: {
    ...
    "confirm.delete.workspace":
      "Bu çalışma alanını silmek istediğinizden emin misiniz? Bu işlem geri alınamaz ve tüm ilişkili tablolar, listeler ve kartlar kalıcı olarak silinecektir.",
    delete: "Sil",
    ...
    "confirm.delete.list":
      "Bu listeyi silmek istediğinizden emin misiniz? İçindeki tüm kartlar kalıcı olarak silinecektir.",
    "confirm.delete.card.title": "Kart Silmeyi Onayla",
    "confirm.delete.card":
      'Kartı "{cardName}" silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.',
    "select.workspace":
      "Başlamak için kenar çubuğundan bir çalışma alanı seçin.",
    "go.back.workspace": "Çalışma alanına geri dön",
